const PricingCard = ({bgColor, title, titleColor, titleBgColor, description, descriptionColor, price, overview, buttonLabel, listItems}) => {
  return(
      <div className={`${bgColor + " " + "d-flex card bg-transparent text-center justify-content-center rounded-3 shadow-lg border-0"}`} style={{width: "20rem"}}>
        
          <div className={`${titleBgColor ? titleBgColor + " " + "p-3 card-header" : "bg-transparent p-3 card-header"}`}>
